...
const HeroSection= () => {
    ...
    />
                ...
                <p className="text-[#788086] text-base sm:text-lg mb-6 ;g:text-xl">
                ...
                <div>
                    ...
                    <button className="px-1 py-1 sm:w-fit rounded-full bg-gradient-to-br from-blue-800 via-green-300 to-orange-700 hover:bg-slate-900 text-blue-800 border border-white mt-4">
                       <span className="block bg-black hover:bg-slate-800 rounded-full px-5 py-2"> Download Curriculumn Vitae</span>
                        </button>
                </div>
        </div>
